 ...
 *            para manipulação de produtos. Este código           *
 ...
 * Descrição: Retorna o pilha->topo == NULL, ou seja verifica se a pilha esta vazia.
 */
 ...
 *            lote - número do loteif (verTopo(minhaPilha) == -1) {
        printf("\nPilha não está mais disponível.\n");
    }
